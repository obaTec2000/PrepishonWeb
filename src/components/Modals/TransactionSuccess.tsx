...
const TransactionSuccess = ({ onSuccess }: any) => {
  const handleSuccess = () => {
    onSuccess();
  };
  return (
    <div className="min-w-[280px] max-w-[400px] w-full h-full font-inter">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="mt-2 font-normal text-[14px] leading-[20px] text-[#475467]">
          You have successfully purchased $100 worth of shares in this property.
        </p>
      </div>
