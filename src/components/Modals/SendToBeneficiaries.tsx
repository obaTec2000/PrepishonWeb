...
const SendToBeneficiaries = ({ onLogout, onCancel }: any) => {
  const handleLogout = () => {
    onLogout();
  };
  ...
  return (
    <div className="max-w-[486px] lg:w-[486px] sm:w-[311px] w-[230px] font-inter">
      ...
      <div className="flex flex-col justify-start items-start">
        ...
        <p className="mt-4">Select Saved NGN Recipient</p>
        <select
      ...
      <div className="flex flex-col-reverse lg:flex-col gap-2 justify-center pt-[32px] w-full">
        <button
          className="min-w-[170px] w-full h-[44px] px-4 py-2 mr-2 bg-[#fff] border-[#D0D5DD] border-[1px] rounded-lg text-[#344054] text-base font-semibold "
...
export default SendToBeneficiaries;
